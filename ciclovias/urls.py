...
from .views import CicloStationsAPIView, CicloviasAPIView, HotZonesAPIView, StationsAPIView, HourlyCountsAPIView, StationsHistogramAPIView, StationsHistogramDBAPIView, TripFlowsAPIView
